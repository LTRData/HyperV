namespace LTR.HyperV.Management.ROOT.virtualization.v2 {
    ...
    // En EarlyBound-klass genererades för WMI-klassen.Msvm_ShutdownComponent
    ...
    public class ShutdownComponent : System.ComponentModel.Component {
        ...
        public const string CreatedClassName = "Msvm_ShutdownComponent";
        ...
        public static ShutdownComponentCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            ...
            pathObj.ClassName = "Msvm_ShutdownComponent";
        ...
        public static ShutdownComponentCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Msvm_ShutdownComponent", condition, selectedProperties));
        ...
        public uint InitiateShutdown(bool Force, string Reason) {
            if ((isEmbedded == false)) {
                System.Management.ManagementBaseObject inParams = null;
                inParams = PrivateLateBoundObject.GetMethodParameters("InitiateShutdown");
                inParams["Force"] = ((bool)(Force));
                inParams["Reason"] = ((string)(Reason));
                System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("InitiateShutdown", inParams, null);
                return System.Convert.ToUInt32(outParams.Properties["ReturnValue"].Value);
            }
            else {
                return System.Convert.ToUInt32(0);
