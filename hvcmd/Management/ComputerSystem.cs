...
// En EarlyBound-klass genererades för WMI-klassen.Msvm_ComputerSystem
...
public class ComputerSystem : System.ComponentModel.Component {
    ...
    public const string CreatedClassName = "Msvm_ComputerSystem";
    ...
    public bool IsEnhancedSessionModeStateNull {
        get {
            if ((curObj["EnhancedSessionModeState"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    public EnhancedSessionModeStateValues EnhancedSessionModeState {
        get {
            if ((curObj["EnhancedSessionModeState"] == null)) {
                return ((EnhancedSessionModeStateValues)(System.Convert.ToInt32(0)));
            }
            return ((EnhancedSessionModeStateValues)(System.Convert.ToInt32(curObj["EnhancedSessionModeState"])));
        }
    }
    ...
    public ReplicationModeValues ReplicationMode {
        get {
            if ((curObj["ReplicationMode"] == null)) {
                return ((ReplicationModeValues)(System.Convert.ToInt32(5)));
            }
    ...
    public ReplicationStateValues ReplicationState {
        get {
            if ((curObj["ReplicationState"] == null)) {
                return ((ReplicationStateValues)(System.Convert.ToInt32(15)));
            }
    ...
    private bool ShouldSerializeEnhancedSessionModeState() {
        if ((this.IsEnhancedSessionModeStateNull == false)) {
            return true;
        }
        return false;
    }
    ...
    public uint InjectNonMaskableInterrupt(out System.Management.ManagementPath Job) {
        if ((isEmbedded == false)) {
            System.Management.ManagementBaseObject inParams = null;
            System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("InjectNonMaskableInterrupt", inParams, null);
            Job = null;
    ...
    public uint RequestReplicationStateChangeEx(string ReplicationRelationship, ushort RequestedState, System.DateTime TimeoutPeriod, out System.Management.ManagementPath Job) {
        if ((isEmbedded == false)) {
            System.Management.ManagementBaseObject inParams = null;
            inParams = PrivateLateBoundObject.GetMethodParameters("RequestReplicationStateChangeEx");
            inParams["ReplicationRelationship"] = ((string)(ReplicationRelationship));
            inParams["RequestedState"] = ((ushort)(RequestedState));
            inParams["TimeoutPeriod"] = ToDmtfDateTime(((System.DateTime)(TimeoutPeriod)));
            System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("RequestReplicationStateChangeEx", inParams, null);
            Job = null;
            if ((outParams.Properties["Job"]?.Value != null)) {
                Job = new System.Management.ManagementPath(outParams.Properties["Job"].Value.ToString());
            }
    ...
    public uint RequestStateChange(ushort RequestedState, System.DateTime? TimeoutPeriod, out System.Management.ManagementPath Job) {
        if ((isEmbedded == false)) {
            ...
            {
                inParams["TimeoutPeriod"] = ToDmtfDateTime(TimeoutPeriod.Value);
            }
