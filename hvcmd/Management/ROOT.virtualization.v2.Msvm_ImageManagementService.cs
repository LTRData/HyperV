namespace LTR.HyperV.Management.ROOT.virtualization.v2 {
    ...
    // En EarlyBound-klass genererades för WMI-klassen.Msvm_ImageManagementService
    ...
    public class ImageManagementService : System.ComponentModel.Component {
        ...
        public const string CreatedClassName = "Msvm_ImageManagementService";
        ...
        public uint ValidatePersistentReservationSupport(string Path, out System.Management.ManagementPath Job) {
            if ((isEmbedded == false)) {
                System.Management.ManagementBaseObject inParams = null;
                inParams = PrivateLateBoundObject.GetMethodParameters("ValidatePersistentReservationSupport");
                inParams["Path"] = ((string)(Path));
                System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("ValidatePersistentReservationSupport", inParams, null);
                Job = null;
                if ((outParams.Properties["Job"]?.Value != null)) {
                    Job = new System.Management.ManagementPath(outParams.Properties["Job"].Value.ToString());
                }
