...
// En EarlyBound-klass genererades för WMI-klassen.Msvm_DiskDrive
[System.CodeDom.Compiler.GeneratedCode("mgmtclassgen", "")]
public class DiskDrive : System.ComponentModel.Component {
    ...
    public const string CreatedClassName = "Msvm_DiskDrive";
    ...
    public DiskDrive(string keyCreationClassName, string keyDeviceID, string keySystemCreationClassName, string keySystemName) {
        this.InitializeObject(null, new System.Management.ManagementPath(DiskDrive.ConstructPath(keyCreationClassName, keyDeviceID, keySystemCreationClassName, keySystemName)), null);
    }
    
    public DiskDrive(System.Management.ManagementScope mgmtScope, string keyCreationClassName, string keyDeviceID, string keySystemCreationClassName, string keySystemName) {
        this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(DiskDrive.ConstructPath(keyCreationClassName, keyDeviceID, keySystemCreationClassName, keySystemName)), null);
    }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsDriveNumberNull {
        get {
            if ((curObj["DriveNumber"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [Browsable(true)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [Description("The number of the physical drives on the hosting computer system.")]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public uint DriveNumber {
        get {
            ...
            return ((uint)(curObj["DriveNumber"]));
        }
    }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsLastCleanedNull {
        get {
            if ((curObj["LastCleaned"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    public System.DateTime LastCleaned {
        get {
            if ((curObj["LastCleaned"] != null)) {
                return ToDateTime(((string)(curObj["LastCleaned"])));
            }
            else {
                return System.DateTime.MinValue;
            }
    ...
    public ulong LoadTime {
        get {
            ...
            return ((ulong)(curObj["LoadTime"]));
        }
    }
    
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsMaxAccessTimeNull {
        get {
            if ((curObj["MaxAccessTime"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public ulong MaxAccessTime {
        get {
            if ((curObj["MaxAccessTime"] == null)) {
                return System.Convert.ToUInt64(0);
            }
            return ((ulong)(curObj["MaxAccessTime"]));
        }
    }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsMaxUnitsBeforeCleaningNull {
        get {
            if ((curObj["MaxUnitsBeforeCleaning"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public ulong MaxUnitsBeforeCleaning {
        get {
            if ((curObj["MaxUnitsBeforeCleaning"] == null)) {
                return System.Convert.ToUInt64(0);
            }
            return ((ulong)(curObj["MaxUnitsBeforeCleaning"]));
        }
    }
    
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsMediaIsLockedNull {
        get {
            if ((curObj["MediaIsLocked"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public bool MediaIsLocked {
        get {
            if ((curObj["MediaIsLocked"] == null)) {
                return System.Convert.ToBoolean(0);
            }
            return ((bool)(curObj["MediaIsLocked"]));
        }
    }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsMountCountNull {
        get {
            if ((curObj["MountCount"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public ulong MountCount {
        get {
            if ((curObj["MountCount"] == null)) {
                return System.Convert.ToUInt64(0);
            }
            return ((ulong)(curObj["MountCount"]));
        }
    }
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public ushort Security {
        get {
            if ((curObj["Security"] == null)) {
                return System.Convert.ToUInt16(0);
            }
            return ((ushort)(curObj["Security"]));
        }
    }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsTimeOfLastMountNull {
        get {
            if ((curObj["TimeOfLastMount"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    public System.DateTime TimeOfLastMount {
        get {
            if ((curObj["TimeOfLastMount"] != null)) {
                return ToDateTime(((string)(curObj["TimeOfLastMount"])));
            }
            else {
                return System.DateTime.MinValue;
            }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsTotalMountTimeNull {
        get {
            if ((curObj["TotalMountTime"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public ulong TotalMountTime {
        get {
            if ((curObj["TotalMountTime"] == null)) {
                return System.Convert.ToUInt64(0);
            }
            return ((ulong)(curObj["TotalMountTime"]));
        }
    }
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsUncompressedDataRateNull {
        get {
            if ((curObj["UncompressedDataRate"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public uint UncompressedDataRate {
        get {
            if ((curObj["UncompressedDataRate"] == null)) {
                return System.Convert.ToUInt32(0);
            }
            return ((uint)(curObj["UncompressedDataRate"]));
        }
    }
    ...
    public string UnitsDescription {
        get {
            return ((string)(curObj["UnitsDescription"]));
        }
    }
    
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool IsUnitsUsedNull {
        get {
            if ((curObj["UnitsUsed"] == null)) {
                return true;
            }
            else {
                return false;
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public ulong UnitsUsed {
        get {
            if ((curObj["UnitsUsed"] == null)) {
                return System.Convert.ToUInt64(0);
            }
            return ((ulong)(curObj["UnitsUsed"]));
        }
    }
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [TypeConverter(typeof(WMIValueTypeConverter))]
    public ulong UnloadTime {
        get {
            if ((curObj["UnloadTime"] == null)) {
                return System.Convert.ToUInt64(0);
            }
            return ((ulong)(curObj["UnloadTime"]));
        }
    }
    ...
    private bool ShouldSerializeDriveNumber() {
        if ((this.IsDriveNumberNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private bool ShouldSerializeLastCleaned() {
        if ((this.IsLastCleanedNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private bool ShouldSerializeLoadTime() {
        if ((this.IsLoadTimeNull == false)) {
            return true;
        }
        return false;
    }
    
    private bool ShouldSerializeMaxAccessTime() {
        if ((this.IsMaxAccessTimeNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private bool ShouldSerializeMaxUnitsBeforeCleaning() {
        if ((this.IsMaxUnitsBeforeCleaningNull == false)) {
            return true;
        }
        return false;
    }
    
    private bool ShouldSerializeMediaIsLocked() {
        if ((this.IsMediaIsLockedNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private bool ShouldSerializeMountCount() {
        if ((this.IsMountCountNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private bool ShouldSerializeTimeOfLastMount() {
        if ((this.IsTimeOfLastMountNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private bool ShouldSerializeTotalMountTime() {
        if ((this.IsTotalMountTimeNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private bool ShouldSerializeUncompressedDataRate() {
        if ((this.IsUncompressedDataRateNull == false)) {
            return true;
        }
        return false;
    }
    
    private bool ShouldSerializeUnitsUsed() {
        if ((this.IsUnitsUsedNull == false)) {
            return true;
        }
        return false;
    }
    
    private bool ShouldSerializeUnloadTime() {
        if ((this.IsUnloadTimeNull == false)) {
            return true;
        }
        return false;
    }
    ...
    private static string ConstructPath(string keyCreationClassName, string keyDeviceID, string keySystemCreationClassName, string keySystemName) {
        string strPath = "root\\virtualization\\v2:Msvm_DiskDrive";
    ...
    public static DiskDriveCollection GetInstances(string[] selectedProperties) {
        return GetInstances(null, null, selectedProperties);
    }
    
    public static DiskDriveCollection GetInstances(string condition, string[] selectedProperties) {
    ...
    public static DiskDriveCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
        ...
        pathObj.ClassName = "Msvm_DiskDrive";
    ...
    public static DiskDriveCollection GetInstances(System.Management.ManagementScope mgmtScope, string[] selectedProperties) {
        return GetInstances(mgmtScope, null, selectedProperties);
    }
    
    public static DiskDriveCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, string[] selectedProperties) {
        if ((mgmtScope == null)) {
            if ((statMgmtScope == null)) {
                mgmtScope = new System.Management.ManagementScope();
                mgmtScope.Path.NamespacePath = "root\\virtualization\\v2";
        ...
        System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("Msvm_DiskDrive", condition, selectedProperties));
    ...
    public uint LockMedia(bool Lock) {
        if ((isEmbedded == false)) {
            System.Management.ManagementBaseObject inParams = null;
            inParams = PrivateLateBoundObject.GetMethodParameters("LockMedia");
            inParams["Lock"] = ((bool)(Lock));
            System.Management.ManagementBaseObject outParams = PrivateLateBoundObject.InvokeMethod("LockMedia", inParams, null);
            return System.Convert.ToUInt32(outParams.Properties["ReturnValue"].Value);
        }
        else {
            return System.Convert.ToUInt32(0);
